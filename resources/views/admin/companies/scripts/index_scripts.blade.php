<script type="text/javascript">
    ...
    $('#datatable_companies').find('tr').on('mouseenter', function () {
    ...
    function ajaxRemoveDt()
    {
        ...
        $.ajax({
            method: "POST",
            url: "{{ route('companies.ajaxDestroy') }}",
            data: {id: id},
            success: function (response) {
                if (response)
                {
                    swal({
                        type: 'success',
                        title: "Negocio eliminado con éxito!",
                        timer: 2000
                    });
                ...
                {
                    swal('Oops...', "Algo ha ido mal al intentar eliminar el negocio.", 'error');
                }
