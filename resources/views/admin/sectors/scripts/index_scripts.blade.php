<script type="text/javascript">
    ...
    $('#datatable_sectors').find('tr').on('mouseenter', function () {
    ...
    function setActionRemove(elem)
    {
        elem.on('click', function (e) {
            ...
            swal({
                type: "warning",
                title: "¿Estás seguro de eliminar este sector?",
        ...
        $.ajax({
            ...
            success: function (response) {
                if (response)
                {
                    swal({
                        type: 'success',
                        title: "Sector eliminado con éxito!",
                        timer: 2000
                    });
                ...
                {
                    swal('Oops...', "Algo ha ido mal al intentar eliminar el sector.", 'error');
                }
