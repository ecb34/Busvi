	...
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title" id="modalEditPassLabel">
			...
			<div class="modal-body">
				<div class="row">
					<div class="col-xs-12">
						{!! Form::model($user, ['route' => ['users.ajaxUpdatePass', $user->id], 'method' => 'POST']) !!}
							<!-- Password Field -->
			...
			<div class="modal-footer">
				...
				<button type="button" class="btn btn-primary pull-left change-pass">
					{{ trans('app.common.save') }}
				</button>
			</div>
		</div>
	</div>
