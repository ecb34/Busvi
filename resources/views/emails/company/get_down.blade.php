...
<body>
	<div class="container">
		...
		<div class="order">
			<div class="customer">
				<p>Se ha solicitado una baja.</p>
				<p>Estos son los datos de la empresa solicitante:<br><br></p>
				<p>Nombre Fiscal: <span>{{ $data->name }}</span></p>
				<p>Nombre Comercial: <span>{{ $data->name_comercial }}</span></p>
				<p>eMail: <span>{{ $data->admin->email }}</span></p>
				<p>Teléfono: <span>{{ $data->admin->phone }}</span></p>
			</div>
		</div>
