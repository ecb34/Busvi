...
<body>
	<div class="container">
		...
		<div class="order">
			<div class="customer">
				@if($data->to_user_id)
					<p>{{$data->emisor->name.' '.$data->emisor->surname}}  te ha enviado un cheque regalo de {{$data->importe}}.</p>
					<p>Lo tienes disponible para su uso en tu seccion Mis cheques regalo<br><br></p>
				@else
					<p>{{$data->emisor->name.' '.$data->emisor->surname}}  te ha enviado un cheque regalo de {{$data->importe}}.</p>
					<p>Para activarlo, entra/registrate en <a href="http://busvi.com">Busvi</a> e introduce el siguiente código:<br></p>
					<p>{{$data->uuid}}</p>
				@endif
			</div>
		</div>
