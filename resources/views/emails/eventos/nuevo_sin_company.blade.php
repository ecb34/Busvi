	...
	<div class="container">
		<header>
			...
			<div class="headerDown">
				<h1>
					Se ha creado un nuevo evento sin negocio asignado
				</h1>
			</div>
		</header>
		...
		<div class="order">
			<div class="customer">
                ...
                <p>Organizador: {{$evento->organizador->name}} {{$evento->organizador->surname}}</p>
                <p>Usuario organizador: {{$evento->organizador->username}}</p>
                <p>Email organizador: {{$evento->organizador->email}}</p>
				<p>Dirección:  {{$evento->direccion}}</p>
				<p>Población:  {{$evento->poblacion}}</p>
                <p>Fecha:  {{date('j/n/y H:i', strtotime($evento->desde))}} {{ !is_null($evento->hasta) ? ' - '.date('j/n/y H:i', strtotime($evento->hasta)) : ''}}</p>
                <p>Descripción:</p>
